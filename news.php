<?php
     ...
     include('header1.php');
      ...
      $reponse = $connect->query('SELECT id, contenu, user_id, created_at FROM news');
...
<?php
   ...
   while($donnees = $reponse->fetch()){
          ...
          $requete4 = $connect->prepare('SELECT COUNT(*) AS contenu FROM news');
        ...
        <img src="<?= $user->avatar ? $user->avatar : get_avatar_url($membres['email'], 100) ?>" alt="Image de profil de <?= $membres['username']  ?>" class="img-circle">
          ...
          <div class="row">
            ...
            <button class="btn btn-danger">nombre de postes: <span class="badge textsuccess">
                <?php   echo $mem['contenu'];  ?> </span></button>    
         <!-- <p style="float: right"> </p>  -->
          ...
          <td>
               ...
               <div class="corps  col-md-6"><?php echo $donnees['contenu']; ?></div>    
 ...
 ?>
                ...
                <?php// if(!empty($_GET['id'])) ?>
                 <div class="status-post">
                    <form method="post"   action="micropost.php"  data-parsley-validate>
                      <div class="form-group">
                           <label for="contenu"></label>
                             <textarea name="contenu"  id="contenu"   row="20"  class="form-control"  style="resize: none"
